...
class Settings(BaseSettings):
    ...
    spatial_reuse_threshold: float = 0.50
    momentum: float = 0.8
    ...
    near_gallery_defer_threshold: float = 0.42
    ...
    attribute_conflict_person_confidence: float = 0.88
    attribute_conflict_tracklet_confidence: float = 0.88
    attribute_conflict_person_min_support: int = 3
    pretrack_static_filter_enabled: bool = False
    pretrack_static_filter_min_frames: int = 4
    pretrack_static_filter_max_width_px: float = 60.0
    pretrack_static_filter_max_height_px: float = 140.0
    pretrack_static_filter_max_center_drift_px: float = 6.0
    static_artifact_filter_enabled: bool = True
    static_artifact_max_mean_width_px: float = 56.0
    static_artifact_max_mean_height_px: float = 140.0
    ...
    duplicate_merge_min_score: float = 0.535
    duplicate_merge_weak_max_tracklets: int = 2
    duplicate_merge_singleton_min_score: float = 0.52
    ...
    duplicate_merge_soft_split_override_threshold: float = 0.75
